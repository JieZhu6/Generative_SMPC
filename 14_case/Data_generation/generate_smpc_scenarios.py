...
def generate_bundle(
    ...
    case : Case14 or None, default=None
        PGLib IEEE-14 系统数据。传入已有对象可避免批量生成时重复构造网络
        参数；为 ``None`` 时由函数内部调用 ``load_case14``。
